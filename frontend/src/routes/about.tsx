  ...
  return (
    <div className="text-foreground selection:bg-gold selection:text-white pb-24">
      ...
      <section className="relative min-h-[75vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 mt-20 md:mt-24 text-black drop-shadow-sm">
          <Reveal variant="fadeUp">
            <img src="/logo.png" alt="King Perfumes" className="mx-auto h-16 auto object-contain animate-float mb-6 opacity-90" />
            <span className="text-sm tracking-[0.3em] uppercase text-black font-semibold">Our Story</span>
            <h1 className="mt-4 font-serif text-5xl md:text-7xl text-black">The Royal Legacy</h1>
            <p className="mt-6 text-lg text-black/80 max-w-2xl mx-auto font-medium leading-relaxed">
