    ...
    <div className="mx-auto max-w-6xl px-4 pt-32 pb-16 md:px-6">
      ...
      <div className="mt-16 grid gap-12 md:grid-cols-2">
        <div className="mt-8 space-y-4">
          {[
            { icon: Mail, label: "Email", value: "kingperfumes11@gmail.com" },
            { icon: Phone, label: "Phone", value: "+91 9558688562" },
            { icon: MapPin, label: "Studio", value: "1st floor, Nakshatra 10, Nakshatra -110, opp. hotel silver palace, Rajkot, Gujarat 360002" },
          ].map((c) => (
