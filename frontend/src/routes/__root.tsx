      ...
      <StoreProvider>
        {isAdmin ? (
          ...
          <div className="flex min-h-screen flex-col relative z-0">
            {/* Background Splash Effect (Perfume Spray) */}
            <div className="fixed inset-0 z-[-10] pointer-events-auto opacity-100">
              <SplashCursor
                TRANSPARENT={true}
                RAINBOW_MODE={false}
                COLOR="#d4af37"
            ...
            <SiteHeader />
            <main key={pathname} className="page-transition flex-1 bg-transparent">
              <Outlet />
            </main>
            <SiteFooter />
          </div>
