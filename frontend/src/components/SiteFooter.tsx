...
import { Crown, Instagram, Facebook, Mail, Phone, MapPin, ArrowUp, Send } from "lucide-react";
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Reveal variant="stagger" delay={0.1}>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="King Perfumes" className="h-12 auto object-contain filter brightness-0 invert opacity-90 hover:opacity-100 transition-opacity" />
              <span className="font-serif text-2xl text-gold">King Perfumes</span>
            </Link>
            ...
            <div className="flex gap-4">
              {[
                { icon: Instagram, url: "https://www.instagram.com/king.perfumes_rajkot/?hl=en" },
                { icon: Facebook, url: "https://www.facebook.com/p/King-Perfumes-61571565824143/" }
              ].map((social, i) => (
                <motion.a 
                  key={i} 
          ...
          <Reveal variant="stagger" delay={0.4}>
            ...
            <ul className="space-y-5 text-sm text-white/70 font-light">
              <li className="flex items-start gap-4">
                ...
                <span className="leading-relaxed">1st floor, Nakshatra 10,<br/>Nakshatra -110,<br/>opp. hotel silver palace <br/> Rajkot, Gujarat 360002</span>
              </li>
              <li className="flex items-center gap-4">
                <Phone className="h-4 w-4 shrink-0 text-gold" />
                <span className="hover:text-gold transition-colors cursor-pointer">+91 9558688562</span>
              </li>
              <li className="flex items-center gap-4">
                <Mail className="h-4 w-4 shrink-0 text-gold" />
                <span className="hover:text-gold transition-colors cursor-pointer">kingperfumes11@gmail.com</span>
              </li>
            </ul>
          </Reveal>
        </div>
