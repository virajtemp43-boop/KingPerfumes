            ...
            <div className="flex items-center gap-4">
              ...
              <motion.div style={{ scale: logoScale }} className="logo-reveal origin-left">
                <Link to="/" className="flex items-center gap-3 transition-colors">
                  <img src="/logo.png" alt="King Perfumes" className="h-10 md:h-12 auto object-contain drop-shadow-sm scale-110 origin-left" />
                  <span className="hidden sm:inline-block drop-shadow-sm font-serif text-2xl tracking-tight text-primary">King Perfumes</span>
                </Link>
              </motion.div>
            </div>
            ...
            >
              <div className="flex items-center justify-between border-b border-border/50 pb-6">
                <span className="flex items-center gap-3">
                  <img src="/logo.png" alt="King Perfumes" className="h-10 auto object-contain drop-shadow-sm scale-110 origin-left" />
                  <span className="font-serif text-2xl tracking-tight text-primary">King Perfumes</span>
                </span>
